...
uint16_t personal_short_address = 11;
...
Position position_main = {0,0};
Position position_B = {0,4};
Position position_C = {4,0};
...
// MAVLINK
//#define LAT_ORIGINE  48.709945
//#define LON_ORIGINE  2.16386
...
const unsigned long SEND_POS_TIMEOUT = 100;
    ...
    if(DW1000NgRTLS::receiveFrame()){
        ...
        if(recv_data[9] == 0xA0) {
            ...
            if(result.success) {
                ...
                Serial.print((String)"t:" + (uint32_t)(micros() - tt));
